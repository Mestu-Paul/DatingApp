    ...
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDTO createMessageDTO){
            ...
            if(group.Connections.Any(x => x.Username == recepient.UserName)){
                ...
                var connection = await PresenceTracker.GetConnectionsForUser(recepient.UserName);
                if(connection!=null){
                    await _presenceHub.Clients.Clients(connection).SendAsync("NewMessageReceived", new {username = sender.UserName, KnownAs = sender.KnownAs});
                }
            }
        ...
        private async Task<Group> RemoveFromMessageGroup(){
            ...
            var connection = group.Connections.FirstOrDefault(x => x.ConnectedId == Context.ConnectionId);
